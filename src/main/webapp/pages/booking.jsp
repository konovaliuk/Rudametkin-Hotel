...
<head>
    ...
    <link href="${pageContext.request.contextPath}/resources/styles/booking.css" rel="stylesheet">
</head>
...
<form action="${pageContext.request.contextPath}/Controller?command=book" method="post">
