...
<div id="found-rooms-container">
    <c:forEach items="${requestScope.foundRooms}" var="item">
...
<c:if test="${requestScope.maxPages > 1 and (empty param.page or (param.page <= requestScope.maxPages and param.page >= 1))}">
    <div id="page-navigation-bar">
        <div style="width: 260px;">
            ...
            <c:choose>
                <c:when test="${(empty param.page and 1 < requestScope.maxPages) or (not empty param.page and param.page < requestScope.maxPages)}">
